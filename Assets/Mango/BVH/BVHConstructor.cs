...
namespace Mango.BVH
{
    public struct ColliderGroup
    {
        ...
        public ComponentDataArray<BVHAABB> AABBs;
        public int Length;
    }
    public unsafe class BVHConstructor
    {
        ...
        public JobHandle Calculate(JobHandle deps, ColliderGroup colliderGroup)
        {
            ComponentDataArray<BVHAABB> AABB = colliderGroup.AABBs;
            ...
            var constructBVHChild = new ConstructBVHChildNodesJob()
            {
                AABB = AABB,
                BVHArray = BVHArray,
                Entities = colliderGroup.Entities,
                indexConverter = indexConverter
            };
